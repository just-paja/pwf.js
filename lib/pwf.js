		...
		return new function()
		{
			...
			var wrap_static_method = function(cdef, key)
			{
				...
				cdef[key] = function(cdef, key, method) {
					return function() {
						return method.apply(cdef, clone_args(arguments));
					};
				}(cdef, key, method);
			};
			...
			{
				return typeof classes[name] != 'undefined';
			};
			...
			this.create = function()
			{
				...
				return this.extend_context(new class_def.fn(), class_def.storage, args);
			};
			...
			this.rc = function(name, opts)
			{
				...
				if (typeof opts.name == 'string') {
					if (typeof opts.parents == 'undefined' || this.has_classes(opts.parents)) {

	...
	return new function()
	{
		...
		this.register_class = function(opts)
		{
			if (typeof opts.name == 'string') {
				this.save_class(this.extend_class(opts));
		...
		this.rc = function(opts)
		{
			if (typeof opts.name == 'string') {
				...
				if (this.has_classes(opts.parents)) {
					this.register_class(opts);
				} else {
					queue_class.push(opts);
				}
			} else throw new Error(['pwf-rc-missing-name', opts]);
